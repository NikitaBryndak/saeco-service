    ...
    <section id="contact" className="py-24 bg-background relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 h-[500px] lg:h-[600px] rounded-3xl overflow-hidden border border-white/10 relative group shadow-2xl">
            <iframe
            ...
            ></iframe>
            <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-auto bg-black/80 backdrop-blur-md px-6 py-4 rounded-2xl border border-white/10 shadow-xl md:max-w-xs">
              <p className="text-white font-medium text-sm md:text-base">м.Хмельницький, вул.Подільська, 171/1</p>
              <a
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            {/* Phone */}
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10 hover:border-accent/50 transition-all duration-300 hover:bg-white/10 group relative overflow-hidden">
              ...
              <div className="flex items-center gap-6 mb-6 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white">Подзвонити</h3>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white/5 p-6 rounded-3xl border border-white/10 hover:border-white/20 transition-all hover:bg-white/10 flex flex-col justify-between h-full">
